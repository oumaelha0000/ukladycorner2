(function(global, factory) {
    ...
    function drawPoint(ctx, options, x, y) {
        ...
        ctx.beginPath();
        switch (style) {
            default: ctx.arc(x, y, radius, 0, TAU);ctx.closePath();
            break;
            case "triangle":
    ...
    const effects = {
        ...
        easeOutBounce(t) {
            ...
            if (t < 2 / d) {
                return m * (t -= 1.5 / d) * t + .75
            }
            if (t < 2.5 / d) {
                return m * (t -= 2.25 / d) * t + .9375
            }
    ...
    class Scale extends Element {
        ...
        _computeGridLineItems(chartArea) {
            ...
            if (position === "top") {
                ...
                if (position === "center") {
                    borderValue = alignBorderValue((chartArea.top + chartArea.bottom) / 2 + .5)
    ...
    class ArcElement extends Element {
        ...
        draw(ctx) {
            ...
            me.pixelMargin = options.borderAlign === "inner" ? .33 : 0;
    ...
    const getBoxSize = (labelOpts, fontSize) => {
        let {
            boxHeight: boxHeight = fontSize,
            boxWidth: boxWidth = fontSize
        } = labelOpts;
    ...
    class CategoryScale extends Scale {
        ...
        buildTicks() {
            ...
            me._startValue = me.min - (offset ? .5 : 0);
